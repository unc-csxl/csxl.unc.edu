...
import { OperatingHoursMobileEditorDialog } from './coworking-admin/coworking-operating-hours-mobile-dialog/coworking-operating-hours-mobile.dialog';
...
@NgModule({
  declarations: [
    ...
    OperatingHoursMobileEditorDialog
  ],
  imports: [
    CommonModule,
    MatCardModule,
