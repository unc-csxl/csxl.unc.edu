...
@api.get("", response_model=list[OrganizationDetail], tags=['Organization'])
...
@api.post("", response_model=OrganizationDetail, tags=['Organization'])
...
@api.get("/{id}", responses={404: {"model": None}}, response_model=OrganizationDetail, tags=['Organization'])
...
@api.get("/name/{name}", responses={404: {"model": None}}, response_model=OrganizationDetail, tags=['Organization'])
...
@api.put("", responses={404: {"model": None}}, response_model=OrganizationDetail, tags=['Organization'])
