...
gwc = OrganizationEntity(
    id=11, 
    name="Girls Who Code", 
    logo="https://cdis.wisc.edu/wp-content/uploads/2022/02/Girls-Who-Code-Seo-e1645894818691.jpeg", 
...
organizations = [
    acm, appteam, bit, cdc, arvr, cssg, ctf, enablingtech, esports, gamedev, gwc, hacknc, ktp, pearlhacks, pm, queerhack, wics
]
