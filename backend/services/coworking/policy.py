...
OH_HOURS = {
    MONDAY: {
        "SN135": [(time(hour=0), time(hour=11, minute=59))],
        "SN137": [(time(hour=0), time(hour=11, minute=59))],
        "SN139": [(time(hour=0), time(hour=11, minute=59))],
        "SN141": [(time(hour=0), time(hour=11, minute=59))],
        "SN144": [(time(hour=0), time(hour=11, minute=59))],
        "SN146": [(time(hour=0), time(hour=11, minute=59))],
        "SN147": [(time(hour=0), time(hour=11, minute=59))],
    },
    TUESDAY: {
        "SN135": [(time(hour=0), time(hour=11, minute=59))],
        "SN137": [(time(hour=0), time(hour=11, minute=59))],
