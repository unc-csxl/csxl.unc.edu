...
OH_HOURS = {
    MONDAY: {
        "SN135": [(time(hour=0), time(hour=23))],
        "SN137": [(time(hour=0), time(hour=23))],
        "SN139": [(time(hour=0), time(hour=23))],
        "SN141": [(time(hour=0), time(hour=23))],
        "SN144": [(time(hour=0), time(hour=23))],
        "SN146": [(time(hour=0), time(hour=23))],
